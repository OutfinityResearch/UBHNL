...
### Categories
- `LexError`: invalid character, unterminated token, etc.
- `ParseError`: violates grammar (DS-005), unexpected token.
- `ResolveError`: unknown predicate/domain/constant, undeclared variable.
